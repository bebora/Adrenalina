...
public class View {
    ...
    public void setupConnection(String connectionType,String username,String password,Properties connectionProperties,boolean existingGame){
		...
		try {
			eventUpdater.login(this, username, password, existingGame, "NORMAL");
		}
		catch (RemoteException e) {
			try {
