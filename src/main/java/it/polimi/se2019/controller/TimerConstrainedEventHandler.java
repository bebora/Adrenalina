 ...
 */
public class TimerConstrainedEventHandler extends Thread implements EventHandler {
    private long start;
    private long time;
    ...
    public TimerConstrainedEventHandler(TimerConstrainedEventHandler timerConstrainedEventHandler) {
        ...
        active = true;
        this.observer = timerConstrainedEventHandler.observer;
        this.requestDispatcher = timerConstrainedEventHandler.requestDispatcher;
        this.acceptableTypes = timerConstrainedEventHandler.acceptableTypes;
        this.blocked = false;
